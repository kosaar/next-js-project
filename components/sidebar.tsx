...
const Sidebar = ({ backgroundColor = 'bg-gray-200' }) => {
  ...
  return (
	...
	<div className="flex items-center p-2 mt-12 rounded space-x-4 justify-self-end">
		<Image src="https://source.unsplash.com/20x20/?portrait"  
		     width={500}
     		 height={500}
			 alt="" 
		...
		/>
		<div>
			<h2 className="text-md font-semibold">Leroy Jenkins</h2>
